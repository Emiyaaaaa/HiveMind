...
description: >-
  ...
  default base. Before push, rewrite commit messages with git commit-tree if they
  contain Cursor trailers. After create, re-apply a clean body and verify with
  gh pr view. Use only when the user explicitly asks to create a PR, open a
